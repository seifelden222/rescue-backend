...
<div class="flex min-h-screen" dir="rtl">
    ...
    <main class="flex-grow p-10 bg-white min-h-screen">
        <div class="flex justify-between items-start mb-10">
            ...
            <button class="bg-[var(--primary)] text-white px-6 py-3 rounded-xl font-bold flex items-center gap-2 shadow-lg shadow-red-100 hover:bg-red-700 transition-all transform active:scale-[0.98]">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <!-- السيارة الأولى: تويوتا هيلوكس -->
            <div class="car-card bg-white border border-slate-100 rounded-[2.5rem] overflow-hidden shadow-sm hover:shadow-xl transition-all flex flex-col group">
                <div class="h-48 overflow-hidden relative">
                    <img alt="Toyota Hilux" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" src="https://lh3.googleusercontent.com/aida-public/AB6AXuA32rthUE2VFpwfQuyRxgBDqGNx4TO6T-l1NggyXzS3z06iAyPyAeiJBcCDHubdfzR1dE-_c81L4lYmc2PK7t0sKSFzY2BMfIsbhBD558cpk0kmp7UWrG-bgYzgruyNDmhIVFanRcY_uRvVxVftlrL5vZSvMIZwbPV3Th-U7pZ2Q-KqNXBz3tNsWpT3gpBRk_1dFhYCh3PtIEFUQ4h5cVBVtF_HF44fPOSX29PD3Vbf4f1wwd8m11qoMyHt6h51VUoOiTdkcbSiB0uJ" />
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center gap-3 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                        <div class="flex-1 flex flex-col items-center border-l border-slate-200">
                            <span class="text-[10px] text-slate-400 font-bold uppercase mb-1">أرقام</span>
                            <span class="text-lg font-black tracking-widest text-[var(--navy)]">1234</span>
                        </div>
                        <div class="flex-1 flex flex-col items-center">
                            <span class="text-[10px] text-slate-400 font-bold uppercase mb-1">حروف</span>
            ...
            <!-- السيارة الثانية: هيونداي إلنترا -->
            <div class="car-card bg-white border border-slate-100 rounded-[2.5rem] overflow-hidden shadow-sm hover:shadow-xl transition-all flex flex-col group">
                <div class="h-48 overflow-hidden relative">
                    <img alt="Hyundai Elantra" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" src="https://lh3.googleusercontent.com/aida-public/AB6AXuA32rthUE2VFpwfQuyRxgBDqGNx4TO6T-l1NggyXzS3z06iAyPyAeiJBcCDHubdfzR1dE-_c81L4lYmc2PK7t0sKSFzY2BMfIsbhBD558cpk0kmp7UWrG-bgYzgruyNDmhIVFanRcY_uRvVxVftlrL5vZSvMIZwbPV3Th-U7pZ2Q-KqNXBz3tNsWpT3gpBRk_1dFhYCh3PtIEFUQ4h5cVBVtF_HF44fPOSX29PD3Vbf4f1wwd8m11qoMyHt6h51VUoOiTdkcbSiB0uJ" />
                    <div class="absolute top-4 left-4 flex gap-2">
                        <button class="w-10 h-10 rounded-full bg-white/90 backdrop-blur-sm text-slate-600 flex items-center justify-center hover:text-[var(--primary)] transition-colors">
                            <span class="material-symbols-outlined text-xl">edit</span>
                        </button>
            ...
            <!-- زر إضافة سيارة جديدة (Dashed) -->
            <button class="border-2 border-dashed border-slate-200 rounded-[2.5rem] p-6 flex flex-col items-center justify-center text-slate-400 hover:border-[var(--primary)] hover:text-[var(--primary)] hover:bg-red-50/30 transition-all group">
                ...
                <span class="font-bold text-lg">إضافة سيارة أخرى</span>
            </button>
        </div>
